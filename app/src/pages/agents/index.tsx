            ...
            <div className="flex items-start">
              ...
              <div className="ml-5">
                ...
                <p className="text-gray-600 leading-relaxed">
                  WinAgent is a lightweight agent designed to monitor and manage
                  thin clients in your network. It sends heartbeat signals to a
                  backend server and allows you to monitor client sessions
                  remotely.
                </p>
              </div>
            </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4 w-full">
                      ...
                      <div className="mt-3 bg-gray-800 rounded-lg p-4 group relative">
                        ...
                        <button
                          className="cursor-pointer absolute top-2 right-2 bg-gray-700 hover:bg-gray-600 text-gray-300 p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity"
                          onClick={() =>
                            handleCopy(
